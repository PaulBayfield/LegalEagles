...
export default function MistralChat() {
    ...
    return (
        <div className="flex flex-row items-center justify-center text-center w-full min-w-full">
            <Documents />
            <div className="flex flex-col h-[600px] mx-auto p-4 w-full ml-20 mr-20">
                <div className="flex items-center space-x-2 mb-4">
                    <MessageCircle className="w-6 h-6" />
                    <h1 className="text-2xl font-bold">ParaChat</h1>
                </div>

                {/* Messages Container */}
                <div className="flex-1 overflow-auto mb-4 space-y-4 bg-gray-50 p-4 rounded-lg dark:bg-gray-800">
                        ...
                        >
                            <div
                                className={`max-w-full rounded-lg p-4 ${
                                    ...
                                    : 'bg-white border border-gray-200 dark:text-black'
                                }`}
                            >
